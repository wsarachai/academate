...
import {
  ...
  deleteGrade,
  updateGrade,
} from "../features/grades/gradesSlide.js";
    ...
    <>
      ...
      <form className="add-form" onSubmit={handleSubmit}>
        ...
        <div className="form-row">
          ...
          {formData.grade && (
            <span
              className={`badge ${GRADE_COLORS[formData.grade] ?? ""} badge--lg`}
            >
              ...
              {grades.map((g, index) =>
                editingId === g.id ? (
                  <tr key={g.id}>
                    ...
                    <td>
                      <span
                        className={`badge ${GRADE_COLORS[editData.grade] ?? ""}`}
                      >
                        {editData.grade}
                      </span>
                    </td>
                  ...
                  <tr key={g.id}>
                    ...
                    <td>
                      <span className={`badge ${GRADE_COLORS[g.grade] ?? ""}`}>
                        {g.grade}
                      </span>
                    </td>
                    <td>
